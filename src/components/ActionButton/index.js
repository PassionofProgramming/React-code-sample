...
export default class ActionButton extends Component {
    constructor(props) {
        ...
        this.state = {
            active: props.active,
            anim: new Animated.Value(props.active ? this.props.opaOnActive : 0),
        };
    ...
    animateButton() {
        ...
        Animated.spring(this.state.anim, {
            toValue: this.props.opaOnActive,
            duration: 250,
        }).start();
                        ...
                        style={
                            [
                                styles.btn,
                                {
                                    width: this.props.size * 1.2,
                                    height: this.props.size * 1.2,
                                    borderRadius: this.props.size * 1.2 / 2,
            ...
            <Animated.Text
                style={[styles.btnText,
                {
                    color: this.state.anim.interpolate({
                        inputRange: [0, this.props.opaOnActive],
                        outputRange: [this.props.btnOutRange, this.props.buttonColor]
                    })
                }]}>
                +
        </Animated.Text>
                ...
                return (
                    ...
                    >
                        ...
                        <ActionButtonItem
                            ...
                            opaOnActive={this.props.opaOnActive}
    ...
    render() {
        ...
        return (
            <View
                pointerEvents="box-none"
                style={[styles.overlay, {elevation: this.props.elevation}]}
            >
                {backdrop}
